<?php
/*
Plugin Name: my-location-perfect
...
add_action( 'save_post', 'my_loc_save_meta_box' );
 ...
 */
function my_loc_save_meta_box( $post_id ) {
	...
	if ( isset( $_POST['post_type'] ) && 'my-location' == $_POST['post_type'] ) {
